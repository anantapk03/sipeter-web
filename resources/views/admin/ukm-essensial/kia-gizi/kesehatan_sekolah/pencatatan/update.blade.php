...
<div class="card">
    ...
    <form action="{{route('kegiatan-program-kia-gizi-pencatatan-UKS-update', ['id'=>$dataKegiatan->id, 'idPencatatan'=>$data->id])}}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select type="text" name="idKelasSiswa" class="form-control" required disabled>
                    <option value="{{$data->idKelasSiswa}}">{{$data->kelasSiswa->namaKelas}}</option>
