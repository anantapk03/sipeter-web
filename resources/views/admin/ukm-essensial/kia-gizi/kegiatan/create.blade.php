...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3>Tambah data Kegiatan {{$dataProgram->namaProgram}}</h3>
        </div>
        <form action="{{route('kegiatan-program-kia-gizi-store', ['id'=>$dataProgram->id])}}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="row" id="targetByDesa">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input id="inputTargetJumlahSetiapDesa" type="number" name="targetJumlahSetiapDesa" class="form-control" required placeholder="Masukan Target Jumlah Kegiatan selama JumlahSetiapDesa...">
                        </div>        
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="inputTargetJumlahDesaMelaksanakan">Target Jumlah Desa Melaksanakan</label>
                            <input id="inputTargetJumlahDesaMelaksanakan" type="number" name="targetJumlahDesaMelaksanakan" class="form-control" required placeholder="Masukan Target Jumlah Kegiatan selama JumlahDesaMelaksanakan...">
                        </div>        
                    </div>
                </div>
