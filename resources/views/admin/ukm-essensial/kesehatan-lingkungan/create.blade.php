...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('kesling.kegiatan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="inputJenisUkbm" type="text" name="kegiatan" class="form-control" required placeholder="Masukan Nama Kegiatan">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
