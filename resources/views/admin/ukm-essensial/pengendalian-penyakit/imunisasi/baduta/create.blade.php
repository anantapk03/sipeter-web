...
<div class="card">
    ...
    <form action="{{route('sasaran-imunisasi-baduta-store')}}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="row" id="targetBaduta">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input id="inputTargetBayiLaki" type="number" min="0" name="sasaran_laki" class="form-control" required placeholder="Jumlah sasaran baduta laki-laki">
                    </div>        
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="inputTargetBayiPerempuan">Target Bayi Perempuan</label>
                        <input id="inputTargetBayiPerempuan" type="number" min="0" name="sasaran_perempuan" class="form-control" required placeholder="Jumlah sasaran baduta Perempuan-Perempuan">
                    </div>        
                </div>
            </div>
            <div class="form-group">
