    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h3>Data Laporan Imunisasi Baduta Desa {{$sasaran->desa->namaDesa}} Bulan {{\App\helpers\MonthHelper::getMonth($sasaran->bulan)}}</h3>
                <div class="dropdown show">
                    <a class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Menu
                    </a>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="{{route('laporan-imunisasi-baduta-create', ['id'=>$sasaran->id])}}"><i class="fas fa-plus-circle"></i> Tambah Laporan</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('laporan-imunisasi-baduta-edit', ['id'=>$sasaran->id, 'idLaporan'=>$item->id])}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> edit</a>
                                    <a href="#" id="deleteConfirmation{{$item->id}}" data-href="{{route('laporan-imunisasi-baduta-destroy', ['id'=>$sasaran->id, 'idLaporan'=>$item->id])}}" data-name="Laporan Imunisasi {{$item->jenisImunisasi->namaImunisasi}}" class="btn btn-sm btn-danger mr-2 mt-2 mb-2"><i class="fas fa-trash"></i> Hapus</a>
