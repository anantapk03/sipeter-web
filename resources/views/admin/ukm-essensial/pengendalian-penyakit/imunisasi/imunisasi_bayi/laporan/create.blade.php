...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h3>Tambah Laporan Imunisasi Bayi Desa {{$sasaran->desa->namaDesa}} Bulan {{\App\helpers\MonthHelper::getMonth($sasaran->bulan)}}</h3>
        </div>
    </div>
    <form action="{{route('P2-Laporan-Imunisasi-store', ['id'=>$sasaran->id])}}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="row" id="catatanJumlahBayi">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input id="jumlahBayiLaki" type="number" min="0" name="jumlah_laki" class="form-control" required placeholder="Jumlah bayi laki-laki...">
                    </div>        
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="jumlahBayiPerempuan">Jumlah Bayi Perempuan</label>
                        <input id="jumlahBayiPerempuan" type="number" min="0" name="jumlah_perempuan" class="form-control" required placeholder="Jumlah bayi perempuan...">
                    </div>       
                </div>
            </div>
            <div class="form-group">
