...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3>Tambah Data Jenis Imunisasi</h3>
        </div>
        <form action="{{ route('imunisasi-wus.jenis.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="inputJenisUkbm" type="text" name="jenis" class="form-control" required placeholder="Masukan Jenis Imunisasi">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
