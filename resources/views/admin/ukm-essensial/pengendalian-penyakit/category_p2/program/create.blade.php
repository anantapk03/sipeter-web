...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3>Tambah Program Pengendalian Penyakit {{$category->namaCategory}}</h3>
        </div>
        <form action="{{route('program-p2-store', ['id'=>$category->id])}}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="inputNamaCategory">Nama Program</label>
                    <input id="inputNamaProgram" type="text" name="namaProgram" class="form-control" required placeholder="Masukan Nama Program">
                </div>
                <div class="form-group">
