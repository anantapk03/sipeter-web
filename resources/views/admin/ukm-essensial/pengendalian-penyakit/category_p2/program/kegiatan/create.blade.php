...
@section('content')
    <div class="card">
        ...
        <form action="{{route('kegiatan-p2-store', ['id'=>$program->id])}}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input id="inputNamaKegiatan" type="number" min="0" name="targetJumlah" class="form-control" required placeholder="Masukan Target Jumlah">
                </div>
                <div class="form-group">
                    <label for="inputDeskripsiKegiatan">Deskripsi</label>
                    <textarea id="inputDeskripsiKegiatan" type="text" name="deskripsi" class="form-control" required placeholder="Masukan Deskripsi"></textarea>
                </div>
            </div>
