...
<div class="card">
    ...
    <form action="{{route('report-store-activity-promkes-month', ['id'=>$dataProgram->id, 'idKegiatan'=>$dataKegiatan->id])}}" method="POST">
        @csrf
        <div class="card-body">
            <div class="form-group">
                <label for="inputNamaKegiatan">Bulan</label>
                <input id="inputNamaKegiatan" type="text" name="namaKegiatan" class="form-control" required placeholder="Masukan Nama Kegiatan" value="{{\App\Helpers\MonthHelper::getMonth($month)}}" disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea id="inputDeskripsiKegiatan" type="text" name="deskripsi" class="form-control" required placeholder="Masukan Deskripsi Pencatatan"></textarea>
            </div>
            <div class="form-group">
                <label for="inputTargetBulanan">Jumlah</label>
                <input id="inputTargetBulanan" type="number" name="jumlah" class="form-control" required placeholder="Masukan Jumlah Kegiatan di bulan ini...">
            </div>  
        </div>
