...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3>Edit Data Wilayah Kerja</h3>
        </div>
        <form action="{{ route('desa.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="inputNamaDesa" type="text" name="desa" class="form-control" required value="{{ $data->namaDesa }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="inputLat">Latitude</label>
                            <input type="text" name="lat" id="lat" class="form-control" required value="{{ $data->lat }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="inputLon">Longitude</label>
                            <input type="text" name="lng" id="lng" class="form-control" required value="{{ $data->lon }}">
                        </div>
                    </div>
                </div>
